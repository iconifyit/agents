...
- If the ADR's "Code being removed" section lists actual removals (i.e. not "None"), DELETE that code in THIS PR. The pivot and the cleanup are one change, not two. Leaving superseded code "for reference" is what git history is for.
